...
jQuery( document ).ready(function( $ ){
	...
	badrSyndication.dialog = {
		...
		_wlDialog: $('<div id="badrSyndication_result" />'),
		_elLoadingImg: '<p align="center"><img src="' + badrSyndication.plugin_url + 'img/loadingAnimation.gif" width="208" /></p>',
		_wlValidator: $('<input type="checkbox" name="doValidater" id="doValidator" /><label for="doValidator">xml문서 정합성 검사</label>'),
		_currentPage: 1,
	  ...
	  setEvent: function( e ) {
		...
		.on( 'dialogopen' , $.proxy(this.loadInfo, this, el ) )
